...
# SLURM job submission script for EarlyDetect Transformer training
...
#
# Usage:
#   sbatch slurm/train_earlydetect.sh                    # No Conv1D (default)
#   sbatch slurm/train_earlydetect.sh --use_temporal_conv  # With Conv1D

#SBATCH --job-name=earlydetect_train
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# export WANDB_RUN_GROUP="earlydetect-training"

echo "========================================"
echo "EARLYDETECT TRANSFORMER TRAINING"
echo "========================================"
...
python scripts/train/earlydetect_train.py \
    ...
    --output_dir "${PROJECT_ROOT}/results/earlydetect" \
...
echo "========================================"
echo "EARLYDETECT TRAINING COMPLETED"
echo "Time: $(date)"
echo "========================================"
